...
public partial class MainWindow : Window
{
    ...
    // --- Widget expanded view state ---
    private string? _expandedWidgetId;
    private int _clockTabIndex; // 0=Clock, 1=Stopwatch, 2=Timer, 3=Alarms
    ...
    // --- Icon Data Constants ---
    private const string PlayIconData = "M8,5.14V19.14L19,12.14L8,5.14Z";
    private const string PauseIconData = "M6,4H10V18H6V4M14,4H18V18H14V4Z";
